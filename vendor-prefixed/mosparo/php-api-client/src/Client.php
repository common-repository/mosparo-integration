...
namespace MosparoDependencies\Mosparo\ApiClient;

use MosparoDependencies\GuzzleHttp\Client as GuzzleClient;
use MosparoDependencies\GuzzleHttp\Exception\GuzzleException;
...
class Client
{
     ...
     * @return \MosparoDependencies\Mosparo\ApiClient\VerificationResult
     *
     * @throws \MosparoDependencies\Mosparo\ApiClient\Exception Submit or validation token not available.
     * @throws \MosparoDependencies\Mosparo\ApiClient\Exception An error occurred while sending the request to mosparo.
     */
     ...
     * @return \MosparoDependencies\Mosparo\ApiClient\StatisticResult
     *
     * @throws \MosparoDependencies\Mosparo\ApiClient\Exception An error occurred while sending the request to mosparo.
     * @throws \MosparoDependencies\Mosparo\ApiClient\Exception Response from API invalid.
     */
